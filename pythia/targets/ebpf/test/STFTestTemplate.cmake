...
#
macro(pythia_add_test_with_args tag driver isXfail alias p4test target arch std enable_runner test_args cmake_args)
  p4c_test_set_name(__testname ${tag} ${alias})
  string(REGEX REPLACE ".p4" "" aliasname ${alias})
  set(__testfile "${P4PYTHIA_DIR}/${tag}/${alias}.test")
  set(__testfolder "${P4PYTHIA_DIR}/${tag}/${aliasname}.out")
  ...
  file(APPEND ${__testfile} "cd ${PyTHIA_BINARY_DIR}\n")
  file(
  ...
  if(${enable_runner})
    ...
    # Find all the stf tests generated for this p4 and copy them to the path where the p4 is, and test them with ebpf model
  ...
  add_test(
    ...
    WORKING_DIRECTORY ${P4PYTHIA_DIR}
  )
...
endmacro(pythia_add_test_with_args)
