#include "backends/pythia/pythia/targets/bmv2/backend/protobuf/protobuf.h"
...
#include "backends/pythia/common/lib/format_bin_hex.h"
...
void Protobuf::emitPreamble(const std::string& preamble) {
    ...
    auto protoFile = parent /= "p4pythia.proto";
...
static std::string getTestCase() {
    static std::string TEST_CASE(
        R"""(# A P4PythIa-generated test case for {{test_name}}.p4
metadata: "p4pythia seed: '{{ default(seed, '"none"') }}'"
...
void Protobuf::emitTestcase(const TestSpec* testSpec, cstring selectedBranches, size_t testId,
    ...
    dataJson["timestamp"] = PythiaUtils::getTimeStamp();
