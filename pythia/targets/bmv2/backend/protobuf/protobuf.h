#ifndef PYTHIA_TARGETS_BMV2_BACKEND_PROTOBUF_PROTOBUF_H_
#define PYTHIA_TARGETS_BMV2_BACKEND_PROTOBUF_PROTOBUF_H_
...
class Protobuf : public TF {
 ...
 private:
    ...
    /// For the protobuf back end this is the "p4pythia.proto" file.
...
#endif /* PYTHIA_TARGETS_BMV2_BACKEND_PROTOBUF_PROTOBUF_H_ */
