#ifndef PYTHIA_CORE_EXPLORATION_STRATEGY_INCREMENTAL_STACK_H_
#define PYTHIA_CORE_EXPLORATION_STRATEGY_INCREMENTAL_STACK_H_
...
#endif /* PYTHIA_CORE_EXPLORATION_STRATEGY_INCREMENTAL_STACK_H_ */
