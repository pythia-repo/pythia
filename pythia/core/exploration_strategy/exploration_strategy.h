#ifndef PYTHIA_CORE_EXPLORATION_STRATEGY_EXPLORATION_STRATEGY_H_
#define PYTHIA_CORE_EXPLORATION_STRATEGY_EXPLORATION_STRATEGY_H_
...
#endif /* PYTHIA_CORE_EXPLORATION_STRATEGY_EXPLORATION_STRATEGY_H_ */
