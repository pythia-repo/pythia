...
PythiaOptions& PythiaOptions::get() {
    static PythiaOptions INSTANCE;
    return INSTANCE;
}

const char* PythiaOptions::getIncludePath() {
    P4C_UNIMPLEMENTED("getIncludePath not implemented for P4Pythia.");
}

PythiaOptions::PythiaOptions()
    ...
    registerOption(
        ...
        "Select the test back end. P4Pythia will produce tests that correspond to the input "
    ...
    registerOption(
        ...
        [](const char*) {
            P4Pythia::enableCoverageLogging();
            return true;
        },
    ...
    registerOption(
        ...
        [](const char*) {
            P4Pythia::enablePerformanceLogging();
            return true;
        },
