#ifndef PYTHIA_LIB_CONCOLIC_H_
#define PYTHIA_LIB_CONCOLIC_H_
...
class ConcolicResolver : public Inspector {
 ...
 private:
    ...
    /// A pointer to the list of implemented concolic methods. This is assembled by the pythia
    /// targets.
