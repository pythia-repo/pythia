#ifndef PYTHIA_LIB_TEST_BACKEND_H_
#define PYTHIA_LIB_TEST_BACKEND_H_

#include <string>
#include <vector>

#include "backends/pythia/common/core/z3_solver.h"
#include "backends/pythia/common/lib/coverage.h"
...
class TestBackEnd {
 protected:
    ...
    explicit TestBackEnd(const ProgramInfo& programInfo, ExplorationStrategy& symbex)
        : programInfo(programInfo), symbex(symbex), maxTests(PythiaOptions::get().maxTests) {
...
#endif /* PYTHIA_LIB_TEST_BACKEND_H_ */
